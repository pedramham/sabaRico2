...
class CategoryServiceType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('panelLastCatService',NumberType::class,array('attr' => array(
                'placeholder' => ' نمایش در قسمت فهرست خدمات  : ',
                'class' => 'form-control',
                'required' => false,
                'value' => $options[0]['panelLastCatService']
            )))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'App\Entity\CategoryService',
