...
class NewsType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('largPic',FileType::class, array(
                'label' => "largPic",
                'required' => false,
            ...
            ->add('description',  CKEditorType::class,  array(
                ...
                'config' => array(
                    ...
                    'extraAllowedContent' => "amp-img[!src,!width,!height,!layout,!title,!alt];p;b;h1;h2;h3;h4;h5;h6;strong;a[!href,title];
            ...
            ->add('panelNewsCategory',NumberType::class,array('attr' => array(
                'placeholder' => ' نمایش در قسمت اخبار و فهرست  : ',
                'class' => 'form-control',
                'required' => false,
                'value' => $options[0]['panelNewsCategory']
            )))
