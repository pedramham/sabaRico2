        ...
        $builder
            ...
            ->add('description',  CKEditorType::class,  array(
                ...
                'config' => array(
                    ...
                    'extraAllowedContent' => "amp-img[!src,!width,!height,!layout,!title,!alt];b;h1;h2;h3;h4;h5;h6;strong;a[!href,title]",
                    'allowedContent' => "true",
                ),
            ))
            ->add('idCategory', EntityType::class,array(
                'data'   =>  $options[0]['idCategory'],
                'class' => 'App:CategoryService',
                'choice_label' => 'name',
                'attr' => array(
                    'label'    => 'فهرست ',
                    'class' => 'form-control'
            ...
            ->add('panelLastService',NumberType::class,array('attr' => array(
                'placeholder' => ' نمایش در قسمت خدمات  : ',
                'class' => 'form-control',
                'required' => false,
                'value' => $options[0]['panelLastService']
            )))
