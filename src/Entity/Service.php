...
class Service
{
    ...
    private $lastUpdate;
    /**
     * @ORM\Column(name="panelLastService",type="integer", nullable=true)
     */
    private $panelLastService;
     ...
     * Set idCategory
     *
     * @param \App\Entity\CategoryService $idCategory
     *
     * @return Service
     */
    public function setIdCategory(\App\Entity\CategoryService $idCategory = null)
    {
     ...
     * Get idCategory
     *
     * @return \App\Entity\CategoryService
     */
    ...
    public function getPanelLastService(): ?int
    {
        return $this->panelLastService;
    }

    public function setPanelLastService(?int $panelLastService): self
    {
        $this->panelLastService = $panelLastService;
