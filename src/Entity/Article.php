...
class Article
{
    ...
    private $lastUpdate;
    /**
     * @ORM\Column(name="panelMainPageTopArticle",type="integer", nullable=true)
     */
    private $panelMainPageTopArticle;
     ...
     * Set idCategory
     *
     * @param \App\Entity\CategoryArticle $idCategory
     *
     * @return Article
     */
    public function setIdCategory(\App\Entity\CategoryArticle $idCategory = null)
    {
     ...
     * Get idCategory
     *
     * @return \App\Entity\CategoryArticle
     */
    ...
    public function getPanelMainPageTopArticle(): ?int
    {
        return $this->panelMainPageTopArticle;
    }

    public function setPanelMainPageTopArticle(?int $panelMainPageTopArticle): self
    {
        $this->panelMainPageTopArticle = $panelMainPageTopArticle;
