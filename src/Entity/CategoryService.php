...
class CategoryService
{
    ...
    /**
     * @ORM\Column(name="panelLastCatService",type="integer", nullable=true)
     */
    private $panelLastCatService;
    ...
    public function getPanelLastCatService(): ?int
    {
        return $this->panelLastCatService;
    }

    public function setPanelLastCatService(?int $panelLastCatService): self
    {
        $this->panelLastCatService = $panelLastCatService;
